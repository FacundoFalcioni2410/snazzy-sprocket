...
function ss_register_acf_fields(): void {
    ...
    acf_add_local_field_group([
        ...
        'fields' => [
            ...
            [
                'key'   => 'field_services_headline',
                'label' => 'Services Section Headline',
                'name'  => 'services_headline',
                'type'  => 'text',
                'default_value' => 'Services built for growth',
            ],
            [
                ...
                'type'  => 'textarea',
                'rows'  => 2,
                'default_value' => 'From concept to launch and beyond, we deliver end-to-end digital solutions that move the needle.',
            ],
            [
            ...
            [
                'key'   => 'field_service_5_label',
                'label' => 'Service 5 Label',
                'name'  => 'service_5_label',
                'type'  => 'text',
            ],
            [
            ...
            [
                'key'   => 'field_service_6_label',
                'label' => 'Service 6 Label',
                'name'  => 'service_6_label',
                'type'  => 'text',
            ],
            [
